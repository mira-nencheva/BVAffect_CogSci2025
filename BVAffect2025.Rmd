...
Word valence from independent ratings was positively associated with the happiness sentiment of the surrounding utterance in the BabyView data (`r papaja::apa_print(model_word_valence_ling_context_happiness)$full_result$scaleling_context_happiness`; Figure 2 - bottom). For example, the average happiness sentiment score for the utterances in which the positive word "smile" was embedded was `r round(mean(merged_data[word == 'smile',ling_context_happiness],na.rm = TRUE),2)` (out of 1), whereas for the negative word "cry" this score was `r round(mean(merged_data[word == 'cry',ling_context_happiness],na.rm = TRUE),2)` (out of 1). Similarly, a relatively neutral word like "eat" has a score of `r round(mean(merged_data[word == 'eat',ling_context_happiness],na.rm = TRUE),2)` (out of 1). 
Word valence was less strongly, but still positively associated with facial happiness (`r papaja::apa_print(model_word_valence_face_happiness)$full_result$scaleface_happiness`; Figure 2 - top). There was a significant interaction between happiness score and the modality of the context (faces vs. sentiment), such that word valence was more strongly associated with the happiness of the utterance in which the word was embedded compared to the happiness displayed by the faces it coocurred with (`r papaja::apa_print(model_word_valence_interaction)$full_result$scalescore_modalitylinguistic_affect`).
